...
export default function Footer() {
  return (
    <>
      <footer
        className="wow fadeInUp p-10 relative z-10 bg-[#090E34] pt-20 lg:pt-[100px]"
        data-wow-delay=".15s"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-10 w-full">
                ...
                <h1 className="mb-8 max-w-[270px] text-text ">
                  We create digital experiences for brands and companies by
                  using technology.
                </h1>
                <div className="-mx-3 flex items-center">
                  <h1 className="px-3 text-text hover:text-white">
                    <svg
                      width="22"
                      height="22"
                      viewBox="0 0 22 22"
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-10 w-full">
                ...
                <ul>
                  <li>
                    <h1 className="mb-3 inline-block text-text  hover:text-primary">
                      Home
                    </h1>
                  </li>
                  <li>
                ...
                <div className="flex flex-col gap-8">
                 <h1
                  ...
                  >
                    ...
                    <span className="max-w-[180px] text-text  group-hover:text-white">
              ...
              <div className="w-full px-4 md:w-2/3 lg:w-1/2">
                <div className="my-1">
                  <div className="-mx-3 flex items-center justify-center md:justify-start">
                    <h1 className="px-3 text-text  hover:text-white hover:underline">
                      Privacy policy
                    </h1>
                    <h1 className="px-3 text-text  hover:text-white hover:underline">
                      Legal notice
