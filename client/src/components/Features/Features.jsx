export default function Features() {
  return (
    <section className="pb-8 p-10 pt-20 bg-secondary lg:pb-[70px] lg:pt-[120px]">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4">
            <div className="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
              ...
              <h2 className="mb-3 text-3xl font-bold text-text dark:text-white sm:text-4xl md:text-[40px] md:leading-[1.2]">
                Main Features Of Play
              </h2>
              <p className="text-text dark:text-white-6">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp group mb-12" data-wow-delay=".1s">
              ...
              <a
                ...
                className="text-text font-medium  hover:text-primary dark:text-white dark:hover:text-primary"
              >
                Learn More
              </a>
            </div>
          ...
          <div className="w-full px-4 md:w-1/2 lg:w-1/4">
            <div className="wow fadeInUp group mb-12" data-wow-delay=".25s">
              ...
              <a
                href="javascript:void(0)"
                className="text-accent font-medium  hover:text-primary dark:text-white dark:hover:text-primary"
              >
                Learn More
              </a>
            </div>
