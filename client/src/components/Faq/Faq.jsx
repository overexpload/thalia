export default function Faq() {
  return (
    <>
      <section className="relative z-20 p-10 overflow-hidden bg-background text-text pb-8 pt-20 dark:bg-dark lg:pb-[50px] lg:pt-[120px]">
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto mb-[60px] max-w-[520px] text-center">
                ...
                <h2 className="mb-3 text-3xl font-bold leading-[1.2] text-dark dark:text-white sm:text-4xl md:text-[40px] pb-5">
                  But, ... ?
                </h2>
              </div>
            </div>
              ...
              <div className="mb-12 flex lg:mb-[70px] p-5">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color dark:text-dark-6">
                    We have no intention of competing with other communities.
                    Our sole objective is to address the challenges that women
                    encounter in society. It's heartening to see other
                    communities striving towards the same goal. Ultimately, the
                    fabric of society heavily relies on the contributions of
                    women.
                  </p>
                </div>
              </div>
            ...
            <div className="w-full px-4 lg:w-1/2">
              ...
              <div className="mb-12 flex lg:mb-[70px] p-5">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color dark:text-dark-6">
                    No, it's a genuine product that we've developed with
                    integrity. However, the product isn't perfect yet. We
                    continue to gather feedback and suggestions from users,
                    constantly enhancing the app. Please feel free to try it out
                    for yourself.
                  </p>
                </div>
              </div>
